...
String[] respuestas = (String[]) sesion.getAttribute("respuesta3");
if (respuestas != null) {
...
sesion.setAttribute("seleccion3", seleccionados);
...
<body>
	<main id="container">
		...
		<form action="Controlador" method="post">
			<p><%=Scriptlets.generaArrayCajasChequeo("respuestas" + contador, Datos.hacerMapa(preguntas, 2), seleccionados)%></p>
